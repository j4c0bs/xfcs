...
class Metadata(object):
    ...
    def prep_required_spec(self, text):
    ...
    def parse_text(self, text):
        self.prep_required_spec(text)
        self.get_channel_attributes(text)
